        ...
        <table class="table table-light">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q31b" value="b:1" <?php echo (in_array('b:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q31c" value="c:1" <?php echo (in_array('c:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q31d" value="d:1" <?php echo (in_array('d:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q31e" value="e:1" <?php echo (in_array('e:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
