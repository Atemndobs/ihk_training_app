        ...
        <table class="table table-light">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42a"
                                   value="a:6" <?php echo (in_array('a:6', $res)) ? 'checked' : '' ?> >
                            6
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42b" value="b:1" <?php echo (in_array('b:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42b"
                                   value="b:6" <?php echo (in_array('b:6', $res)) ? 'checked' : '' ?> >
                            6
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42c" value="c:1" <?php echo (in_array('c:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42c"
                                   value="c:6" <?php echo (in_array('c:6', $res)) ? 'checked' : '' ?> >
                            6
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42d" value="d:1" <?php echo (in_array('d:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42d"
                                   value="d:6" <?php echo (in_array('d:6', $res)) ? 'checked' : '' ?> >
                            6
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42e" value="e:1" <?php echo (in_array('e:1', $res)) ? 'checked' : '' ?> >
                            1
                        </label>
                    </div>
                </td>
                ...
                <td>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="q42e"
                                   value="e:6" <?php echo (in_array('e:6', $res)) ? 'checked' : '' ?> >
                            6
                        </label>
                    </div>
                </td>
